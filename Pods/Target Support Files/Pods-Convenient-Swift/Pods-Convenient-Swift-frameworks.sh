...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods-Convenient-Swift/Alamofire.framework"
  install_framework "Pods-Convenient-Swift/AlamofireObjectMapper.framework"
  ...
  install_framework "Pods-Convenient-Swift/SVProgressHUD.framework"
